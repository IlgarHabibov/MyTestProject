...
fun main() {
    ...
    val rangeE = 51 .. 60
    val operator = 99
    if (operator in rangeA) {
        println("A")
    } else if (operator in rangeB) println("B")
    else if (operator in rangeC) println("C")
    else if (operator in rangeD) println("D")
    else if (operator in rangeE) println("E")
    else {
        println("not found")
    }
    ...
    val letters = 'a' rangeTo 'z'
    val lettersCap = 'A' rangeTo 'Z'
    symbol.isDigit()
    symbol.isLetter()
    when (symbol) {
        in digits -> println("Digit")
        in letters -> println("letter")
        in lettersCap -> println("letter")
        else -> println("symbol")
    }
